...
; Generated by aerror on 2020/12/9 (UTC)
;
[Setup]
AppID={{a1f1ef1f-1742-46c9-977b-a76a3bb59167}
AppName=ASCOM LsFocuser Focuser Driver
AppVerName=ASCOM LsFocuser Focuser Driver 1.0.0
AppVersion=1.0.0
AppPublisher=aerror <aerror@outlook.com>
AppPublisherURL=mailto:aerror@outlook.com
...
OutputDir="."
OutputBaseFilename="LsFocuser Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\LsFocuser"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\LsFocuser"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "Z:\data\Codes\LsAutoFocuser\LsFocus\bin\x64\Release\ASCOM.LsFocuser.Focuser.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "Z:\data\Codes\LsAutoFocuser\LsFocus\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.LsFocuser.Focuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.LsFocuser.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.LsFocuser.Focuser.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.LsFocuser.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.LsFocuser.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
