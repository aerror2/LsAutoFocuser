...
//
// ASCOM Focuser driver for LsFocuser
//
...
{
    //
    // Your driver's DeviceID is ASCOM.LsFocuser.Focuser
    //
    // The Guid attribute sets the CLSID for ASCOM.LsFocuser.Focuser
    // The ClassInterface/None attribute prevents an empty interface called
    // _LsFocuser from being created and used as the [default] interface
    //
    ...
    /// ASCOM Focuser Driver for LsFocuser.
    /// </summary>
    [Guid("1f7e9bd3-372f-4dd9-8106-52f1b21cd113")]
    ...
    public class Focuser : IFocuserV3
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.LsFocuser.Focuser";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Focuser Driver for LsFocuser.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LsFocuser"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public Focuser()
        {
            tl = new TraceLogger("", "LsFocuser");
        ...
        public void Move(int Position)
        {
            ...
            if (Position > MaxStep || Position < 0)
                return;
